...
ALTER TABLE "notifications" ADD CONSTRAINT "notifications_target_id_profile_profile_id_fk" FOREIGN KEY ("target_id") REFERENCES "public"."profile"("profile_id") ON DELETE cascade ON UPDATE no action;